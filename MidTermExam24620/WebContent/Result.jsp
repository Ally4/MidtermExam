...
<%@page import="com.auca.themodel.CourseData"%>
...
<%@ page import="com.auca.themodel.StudentRegistration" %>
<%@ page import="com.auca.themodel.StudentCourse" %>
<%@ page import="com.auca.themodel.Course" %>
<%@ page import="com.auca.themodel.CourseData" %>
<%@ page import="com.auca.themodel.CourseDefinition" %>
<%@ page import="java.util.ArrayList" %>
<%@ page import="com.auca.theutil.HibernateUtil" %>
